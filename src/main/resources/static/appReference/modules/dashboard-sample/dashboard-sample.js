(function() {
  ...
  angular.module('singApp.dashboard-sample')
    .controller('dashboardSampleController', dashboardSampleController)
  ...
  dashboardSampleController.$inject = ['$scope'];
  function dashboardSampleController ($scope) {
