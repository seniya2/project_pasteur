(function() {
  'use strict';
  	...
  	electricAlarmController.$inject = ['config', '$scope', '$resource', '$http', '$location', '$filter', '$timeout', 'usSpinnerService' ];
    function electricAlarmController (config, $scope, $resource, $http, $location, $filter, $timeout, usSpinnerService) {
		...
		$scope.template_base = "appPasteur/modules/energy/electric/alarm-manage/";
		...
		$scope.entityName = "alarmElectric";
    ...
    angular.module('singApp.electric-alarm').controller('electricAlarmController', electricAlarmController);
