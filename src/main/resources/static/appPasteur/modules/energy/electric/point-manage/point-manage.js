(function() {
  'use strict';
  	...
  	electricPMModelController.$inject = ['config', '$scope', '$resource', '$filter', 'usSpinnerService', '$timeout', '$compile','$sce', '$location', '$http'];
    function electricPMModelController (config, $scope, $resource, $filter, usSpinnerService, $timeout, $compile, $sce, $location, $http) {
    	
    	$scope.categoryName = "electric";
		$scope.template_base = "appPasteur/modules/energy/electric/point-manage/";
  ...
  angular.module('singApp.energy-electric-point-manage').controller('electricPMModelController', electricPMModelController);
