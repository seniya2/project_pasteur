(function() {
  'use strict';
  	...
  	electricGraphViewController.$inject = ['config', '$scope', '$resource', '$http', '$location', '$filter', '$timeout', 'usSpinnerService' ];
    function electricGraphViewController (config, $scope, $resource, $http, $location, $filter, $timeout, usSpinnerService) {
			
		$scope.template_base = "appPasteur/modules/energy/electric/graph-view/";
		...
		$scope.viewAction = function(point) {
			...
			//$scope.chageLogSectionClass(tagIDs.length);
  ...
  angular.module('singApp.electric-graph-view').controller('electricGraphViewController', electricGraphViewController);
