(function() {
  'use strict';
  	...
  	upsPointController.$inject = ['config', '$scope', '$resource', '$filter', 'usSpinnerService', '$timeout', '$compile','$sce', '$location', '$http','$q'];
    function upsPointController (config, $scope, $resource, $filter, usSpinnerService, $timeout, $compile, $sce, $location, $http, $q) {
    	
    	var search = $location.search();
    	
		$scope.categoryName = "ups";
		$scope.template_base = "appPasteur/modules/energy/ups/point-manage/";
    ...
    angular.module('singApp.ups-point-manage').controller('upsPointController', upsPointController);
