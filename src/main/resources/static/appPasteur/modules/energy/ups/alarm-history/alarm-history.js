(function() {
  'use strict';
  	...
  	upsHistoryModelController.$inject = ['config', '$scope', '$resource', '$http', '$location', '$filter', '$timeout', 'usSpinnerService', '$compile','$sce' ];
    function upsHistoryModelController (config, $scope, $resource, $http, $location, $filter, $timeout, usSpinnerService, $compile, $sce) {
		...
		$scope.template_base = "appPasteur/modules/energy/ups/alarm-history/";
		$scope.resources_base = "appPasteur/modules/energy/ups/point-manage/resources/";
    ...
    angular.module('singApp.ups-history').controller('upsHistoryModelController', upsHistoryModelController);
