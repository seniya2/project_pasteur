(function() {
  'use strict';
  	...
  	hvacAlarmController.$inject = ['config', '$scope', '$resource', '$http', '$location', '$filter', '$timeout', 'usSpinnerService' ];
    function hvacAlarmController (config, $scope, $resource, $http, $location, $filter, $timeout, usSpinnerService) {
		...
		$scope.template_base = "appPasteur/modules/energy/hvac/alarm-manage/";
    ...
    angular.module('singApp.hvac-alarm').controller('hvacAlarmController', hvacAlarmController);
