(function() {
  'use strict';
  	...
  	lightingPMModelController.$inject = ['config', '$scope', '$resource', '$filter', 'usSpinnerService', '$timeout', '$compile','$sce', '$location', '$http'];
    function lightingPMModelController (config, $scope, $resource, $filter, usSpinnerService, $timeout, $compile, $sce, $location, $http) {
