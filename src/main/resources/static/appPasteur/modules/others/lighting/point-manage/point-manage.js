(function() {
  'use strict';
  	...
  	lightingPMModelController.$inject = ['config', '$scope', '$resource', '$http', '$location', '$filter', 'usSpinnerService', '$timeout' ];
    function lightingPMModelController (config, $scope, $resource, $http, $location, $filter, usSpinnerService, $timeout) {
    	
    	$scope.categoryName = "lighting";
		$scope.template_base = "appPasteur/modules/others/lighting/point-manage/";
		...
		$scope.csvConfig = {
				...
				complete: function(results, file) {
					...
					$timeout(function(){usSpinnerService.stop('app-spinner-ol')}, 1000);
				},
				error: undefined,
				download: true,
