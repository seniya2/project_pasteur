(function() {
  'use strict';
  	...
  	fireAlarmController.$inject = ['config', '$scope', '$resource', '$http', '$location', '$filter', '$timeout', 'usSpinnerService' ];
    function fireAlarmController (config, $scope, $resource, $http, $location, $filter, $timeout, usSpinnerService) {
		...
		$scope.template_base = "appPasteur/modules/emergency/fire/alarm-manage/";
    ...
    angular.module('singApp.fire-alarm').controller('fireAlarmController', fireAlarmController);
